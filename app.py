...
def update_world_map(selected_year, data_type):
    ...
    fig.update_layout( # Set margins to 0 to remove the border surrounding the map and setting colors
        plot_bgcolor='#212529',
        paper_bgcolor='#212529',
        font=dict(color='#FFFFFF')
    )
    fig.update_geos(bgcolor='#212529', showcountries=False, showframe=False)  #
...
def update_stacked_area_chart(selected_year):
    ...
    layout = go.Layout(   # Create the layout and figure to be returned
        title=f'Total CO2 Emissions By Type Over Time until {selected_year}',
